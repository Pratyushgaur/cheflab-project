            ...
            <div class="row">
              <div class="col-5 col-sm-3">
                <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                  ...
                  <a class="nav-link" id="vert-tabs-profile-tab" data-toggle="pill" href="#vert-tabs-profile" role="tab" aria-controls="vert-tabs-profile" aria-selected="false">Vendor Terms & Condition</a>
                  <a class="nav-link" id="vert-tabs-messages-tab" data-toggle="pill" href="#vert-tabs-messages" role="tab" aria-controls="vert-tabs-messages" aria-selected="false">Cheflab Terms & Condition</a>
                  <a class="nav-link" id="vert-tabs-settings-tab" data-toggle="pill" href="#vert-tabs-settings" role="tab" aria-controls="vert-tabs-settings" aria-selected="false">Deliveryboy Terms & Condition</a>
                  <a class="nav-link" id="vert-tabs-refund-tab" data-toggle="pill" href="#vert-tabs-refund" role="tab" aria-controls="vert-tabs-refund" aria-selected="false">Refund Cancellation</a>
                </div>
              </div>
                ...
                <div class="tab-content" id="vert-tabs-tabContent">
                  <div class="tab-pane text-left fade show active" id="vert-tabs-home" role="tabpanel" aria-labelledby="vert-tabs-home-tab">
                    <div class="card card-outline card-info">
                        ...
                        <div class="card-body pad table-responsive">
                            <form id="restaurant-form" action="{{route('admin.globle.storePrivacy')}}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="tab-pane fade" id="vert-tabs-profile" role="tabpanel" aria-labelledby="vert-tabs-profile-tab">
                    <div class="card card-outline card-info">
                          ...
                          <!-- /.card-header -->
                          <div class="card-body pad table-responsive">
                              <form id="restaurant-form" action="{{route('admin.globle.storeVendorTC')}}" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                  <div class="card card-default">
                                      <div class="card-body">
                                          <input type="hidden" name="id" value="{{$data->id}}">
                  ...
                  <div class="tab-pane fade" id="vert-tabs-messages" role="tabpanel" aria-labelledby="vert-tabs-messages-tab">
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            <h3 class="card-title">
                            Cheflab Terms & Condition
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body pad table-responsive">
                            <form id="restaurant-form" action="{{route('admin.globle.storeCheflabTC')}}" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                 <div class="card card-default">
                                    <div class="card-body">
                                        <input type="hidden" name="id" value="{{$data->id}}">
                                        <textarea id="cheflabtc" name="terms_conditions_cheflab">
                                            {{$data->terms_conditions_cheflab}}
                                        </textarea>
                                    </div>
                                    <div class="card-footer">
                                        <button class="btn btn-success" ><i class="fa fa-save"></i>Update </button>
                            ...
                            <form id="restaurant-form" action="{{route('admin.globle.storeDeliveryTC')}}" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                 <div class="card card-default">
                                    <div class="card-body">
                                        <input type="hidden" name="id" value="{{$data->id}}">
                                        <textarea id="deliveryboy" name="terms_conditions_deliverboy">
                  ...
                  <div class="tab-pane fade" id="vert-tabs-refund" role="tabpanel" aria-labelledby="vert-tabs-refund-tab">
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            <h3 class="card-title">
                            Refund Cancellation Deliveryboy
                            </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body pad table-responsive">
                            <form id="restaurant-form" action="{{route('admin.globle.storeRefund')}}" method="post" enctype="multipart/form-data">
                               <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                 <div class="card card-default">
                                    <div class="card-body">
                                        <input type="hidden" name="id" value="{{$data->id}}">
