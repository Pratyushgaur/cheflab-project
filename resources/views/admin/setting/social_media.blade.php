...
<div class="content-wrapper">
    ...
    <section class="content">
		<div class="row">
				...
				<div class="col-md-4">
        <form id="restaurant-form" action="{{route('admin.globle.socialmedia_add')}}" method="post" enctype="multipart/form-data">
          @if ($errors->any())
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" id="position" name="link" value="{{!empty($class_name[0]->answer) ? $class_name[0]->answer : ''}}" class="form-control" placeholder="Ex :facebook.com/your-page-name "></textarea>
                    </div>
                </div>
                <!-- /.card-body -->
			</div>
