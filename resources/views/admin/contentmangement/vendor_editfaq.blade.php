...
<div class="content-wrapper">
    ...
    <section class="content">
		<div class="row">
				...
				<div class="col-md-12">
        <form id="restaurant-form" action="{{route('admin.vendor.store_faq')}}" method="post" enctype="multipart/form-data">
          @if ($errors->any())
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="hidden" id="faq_question" value="{{$faq->faq_question}}" name="id"  class="form-control" placeholder="Your Question">
