                ...
                <div class="col-md-12"> 
                  <div class="card card-primary card-outline">
                    ...
                    <div class="card-header">
                      <h3 class="card-title">Update Refer Amount </h3>
                                ...
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$refer_amount->refer_amount}}" name="refer_amount" class="form-control"  id="exampleInputEmail1" placeholder="Refer Amount">
                                        <input type="hidden" name="id" value="{{$refer_amount->id}}" class="form-control"  id="exampleInputEmail1" placeholder="Enter Business Name">
                                    </div>  
                                  </div>
                                </div>
