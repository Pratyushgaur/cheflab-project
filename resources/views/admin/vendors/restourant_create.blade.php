                      ...
                      <form id="restaurant-form" action="{{route('admin.restourant.store')}}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="restourant_name" class="form-control"  id="exampleInputEmail1" placeholder="Enter Restaurant Name">
                                    </div>  
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Email <span class="text-danger">*</span></label>
                                        <input type="email" name="email" class="form-control"  id="" placeholder="Enter Restourant Email">
                                    </div>  
                                  </div>
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control"  id="" placeholder="Enter Restourant Address">
                                    </div>  
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">FSSAI Lic. No. <span class="text-danger">*</span></label>
                                        <input type="text" name="fassai_lic_no" class="form-control"  id="" placeholder="Enter Fassai licence Number">
                                    </div>  
                                  </div>
                                  <div class="col-md-4">
                                    <div class="form-group">
                          ...
                          <div class="card card-default">
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-sm-3">
                                        <div>
                                          <label for="">Restourant Images</label>
                                        </div>
                          ...
                          <div class="card-footer">
                            <button class="btn btn-success" ><i class="fa fa-save"></i> Restourant  Register </button>
                          </div>
                      </form>
