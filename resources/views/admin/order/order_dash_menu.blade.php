...
<a href="{{route('admin.order.dashboard.status','fail_order_generate')}}" class="btn btn-sm @if($active == 'fail_order_generate') active @endif" style="border:1px solid black;">Fail Generate Orders</a>
