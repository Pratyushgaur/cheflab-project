...
@section('content')
      ...
      <div class="content-wrapper">
        ...
        <form id="restaurant-form" action="{{route('admin.account.rider.payRider')}}" method="post" >
              ...
              <div class="row"> 
                ...
                <div class="col-6"> 
                  ...
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" value = "{{ $data->paid_amount }}" id="amounUtr" name="amount" readonly>
                    </div> 
                  </div>
                </div>
              </div>
