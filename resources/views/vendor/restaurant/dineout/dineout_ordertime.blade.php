            ...
            <div class="col-md-9">
                <div class="ms-panel">
                    <div class="ms-panel-header">
                        <h6>Dine-out Time Setting</h6>
                    </div>
                    <div class="ms-panel-body">
                        <form class="validation-fill clearfix " id="menu-form"
                            action="{{ route('restaurant.dineout.update_dine_out_order_time') }}" method="post">
                            @csrf

                            @include('vendor.restaurant.alertMsg')
                            {{-- Order time form start --}}
                            @include('vendor.restaurant.dineout.dineout_order_time_fields')
