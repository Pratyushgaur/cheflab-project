...
<head>
  ...
  <title>Cheflab Enter OTP For Change Password</title>
  <!-- Iconic Fonts -->
      ...
      <div class="ms-auth-container">
        ...
        <div class="ms-auth-col">
          <div class="ms-auth-form">
            ...
            @csrf   
              <h3>Vendor's Forget Password </h3>
              ...
              <button class="btn btn-primary mt-4 d-block w-100" type="submit">Change Password</button> 
