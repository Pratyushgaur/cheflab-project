        ...
        <div class="col-xl-8 col-md-12">
          <div class="ms-panel ms-panel-fh">
            ...
            <div class="ms-panel-body">
              <form class=" clearfix" id="product-form" action="{{route('restaurant.product.update')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <div class="input-group">
                      ...
                      <input type="hidden" name="id" value="{{$product->id}}" class="form-control" id="validationCustom18" placeholder="Product Name" value="">
                        ...
                        <div class="image-upload">
                          <label for="file-input">
                              <div class="upload-icon">
                                  <img class="icon" src="{{ asset('products'.'/'.$product->product_image) }}">
                              </div>
                          </label>
