   ...
   <div>
      <div class="invoice_body">
               ...
               <tr>
                  <td style="width:50%;">
                     <table>
                        ...
                        <tr>
                           <td><b>State:</b> Madhya Pradesh (23) </td>
                        </tr>
                     </table>
                  </td>
                  <td style="width:50%;">
            ...
            <table style="width:100%;border-collapse: collapse;" border="1" cellpadding="4">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        <?php 
                           $convenience = $invoice->gross_revenue*2/100;;
                           $commission = $invoice->gross_revenue*9/100;
                           $taxable = $commission+$convenience;
                           $tax = $taxable*18/100;
                           $total = $taxable+$tax;
                        ?>
                  ...
                  <tr>
                     ...
                     <td style="text-align: right;">{{number_format($taxable,2)}}</td>
                  </tr>
                  <tr>
                     <td></td>
                     <td style="text-align: right;">SGST @ 9.00%</td>
                     <td style="text-align: right;">{{number_format($tax/2,2)}}</td>
                  </tr>
                  <tr>
                     <td></td>
         ...
         <div class="amount_english">
            ...
            <p>Amount INR {{number_format($total,2)}} settled through digital mode through multiple transactions net payout settlement dated {{date('d M Y',strtotime($invoice->created_at))}}</p>
         </div>
