            ...
            <div class="col-md-12">
                <div class="ms-panel">
                    ...
                    <div class="ms-panel-body pb-0">
                        <div class="row">
                            <?php
                            $blog = \App\Models\AppPromotionBlogs::find($appPromotionBlogBooking->app_promotion_blog_id);
                            ...
                            <div class="col-md-12 ">
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            <td>Time During:</td>
                                            <td>{{front_end_time($blog->from).' - '.front_end_time($blog->to)}}</td>
                                        </tr>
                                        <tr>
                                            <td>Date:</td>
                                            <td>{{front_end_date($appPromotionBlogBooking->from_date).' - '.front_end_date($appPromotionBlogBooking->to_date)}}</td>
                                        </tr>

                                        <tr>
                                            <td>Position:</td>
                                            <td>{{$app_promotion_blog_setting->blog_position}}</td>
                                        </tr>
                                    </table>
                                    <div class="col-md-12 " style="margin-bottom: 30px;">
                                        <form action="{!!route('payment')!!}" method="POST" id="pay" name="pay">
