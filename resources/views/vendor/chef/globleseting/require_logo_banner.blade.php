                            ...
                            <div class="col-md-12">
                                <nav aria-label = "breadcrumb">
                                    <ol class = "breadcrumb breadcrumb-arrow has-gap has-bg">
                                        ...
                                        <li class = "breadcrumb-item"><a href = "{{route('chef.globleseting.frist_vendor_location')}}">Location</a></li>
                                        <li class = "breadcrumb-item"><a href = "{{route('chef.globleseting.first_vendor_logo')}}">Logo And Banner</a></li>
                                        <li class = "breadcrumb-item active"><a href = "{{route('chef.globleseting.first_bank_details')}}">Bank Details</a></li>
                                    </ol>
                                </nav>
                                <form class="validation-fill clearfix " id="menu-form" action="{{ route('chef.globleseting.save_vendor_logo') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <a class="btn btn-light " href="{{route('chef.globleseting.frist_vendor_location')}}" >Back</a>
                                        </div>
                                        <div class="col-md-6 mb-6">
