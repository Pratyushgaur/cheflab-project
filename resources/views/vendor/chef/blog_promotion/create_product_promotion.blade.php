            ...
            <div class="col-xl-12 col-md-12">
                <div class="ms-panel ms-panel-fh">
                    <div class="ms-panel-header">
                        <h6>Create New Product Promotion</h6>
                    </div>
                    <div class="ms-panel-body">
                        <form class=" clearfix " id="coupon-form" action="{{route('chef.product.promotion.save')}}"
                            ...
                            <div class="form-row">
                                <div class="col-xl-6 col-md-6 mb-3">
                                    <label for="validationCustom10">Select Product</label>
                                    <div class="input-group">
                                        {{ Form::select('product_id',$products,null,['class' => 'select2 form-control','id'=>'product_id', 'placeholder' => 'Select Product']) }}
                                    </div>
                                    <p class="ms-directions">This list has those products that have an image.</p>
...
@section('page-js')
    ...
    <script type="text/javascript">
        ...
        function get_positions() {
            ...
            $.ajax({
                    type: "POST",
                    url: '{{route("chef.shop.promotion.positions")}}', // This is what I have updated
