...
{{-- restaurant offline msg on top bar  --}}
    ...
    <div id='message-box'>Now your restaurant is offline,you will not able to get orderds from mobile app.<a href="#" style="float: right;    margin-right: 18px;" id="close_msg_bar">X</a></div>
    @endif
