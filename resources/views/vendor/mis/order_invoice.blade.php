...
<html>
   <head>
      ...
      <style type="text/css">
         ...
         .billingDetails h4, .billingDetails p, .billingDetails_1 p, .billingDetails_1 h4 {
         margin: 3px 0px;
         font-size: 10px;
         line-height: 13px;
         }
         ...
         address.pancard p ,.Ordernumber p,.private p,.invoice_logo h6{
         margin: 0px;
         }
         .shopping_1 {
         ...
         .billingDetails ,.billingDetails_1  {
         margin-top: 10px;
         }
         .shoppingaddress{
         margin-top: 7px;
...
.address_box p, .work_description p {   
    margin: 0;
    line-height: 12px;
    font-weight: 500;
    font-size: 13px;
         ...
         <table style="width: 100%;">
            <tbody>
               ...
               <div class="invoice_logo">
				  <h6 style="font-size:11px;"><img src="http://chelab.local.com/commonarea/logo1.png" style="width:100px;"> </h6>
               </div>
               ...
               <tr>
				...
				<div class="heading_invoice">
					<div class="inner_invoice">
						<h4 style="font-size:18px;margin: 0;line-height: 24px;">TAX INVOICE </h4>
						<p style="font-size:14px;margin: 2px 0;">Original for Recipient</p>
                  <h5 style="font-size:13px;margin-top:12px;text-transform: uppercase;text-align: left;">Chelab Limited (Formerly known as Chelab private limited and chelab media private limited) </h5>						
					</div>
				</div>
          ...
          <table style="width:100%;">
               <tr>
                  <td style="width:50%;">
                     <table>
                        <tr>
                           <td><b>Address:</b> Flat 202, Royal Platinum Building, Near BCM
                              Heights, Vijaynagar, Indore - 452010</td>
                        </tr>
                        <tr>                          
                        ...
                        <tr> 
                           <td><b>Invoice No:</b> Z22-MPOO-030274</td>
                        </tr>
                        <tr> 
                           <td><b>Invoice Date:</b> 2021-11-30</td>
                        </tr>
                     </table>
                  </td>
                  <td  style="width:50%;">
                     <table>
                        ...
                        <tr>                  
                           <td><b>GSTIN:</b> 23AADCD4946L1ZI</td>
                        </tr>
                        <tr>
                           <td><b>Email:</b> 02help@zomato.com</td>
                        </tr>
                     </table>
                  </td>
               </tr>
              ...
              <tr>
                 <td style="width:50%;">
                    <table>
                       ...
                       <tr>                          
                          <td><b>Entity Name:</b>  PRIYANKA TYAGI</td>                           
                       </tr>
                       <tr>                         
                          <td><b>Merchant ID:</b> 146926 </td>
                       </tr>
                       <tr>   
                          <td><b>Trade Name:</b> Mom's Rasoi</td>
                       </tr>
                       <tr> 
                          <td><b>Address:</b> 270/15, Nanda Nagar, Jhanda Chowk, Indore,
                           HIG-LIG, Indore, Indore, Madhya Pradesh</td>
                       </tr>                       
                    </table>
                 </td>
                 <td  style="width:50%;">
      ...
      <div class="work_heading" style="margin: 10px 0;">
         ...
         <table style="width:100%;border-collapse: collapse;" border="1" cellpadding="4">
            ...
            <tbody>
               <tr>
                  <td></td>
                  <td><b>Period: </b> 01-Nov-2021 To 30-Nov-2021</td>
                  <td></td>
               </tr>
               <tr>
                  <td>1</td>
               ...
               <tr>
                  ...
                  <td style="text-align: right;"><b>169.96</b></td>
               </tr>
            </tbody>
         </table>
      </div>
         <div class="amount_english">
            ...
            <p>Amount INR 169.96 settled through digital mode through multiple transactions net payout settlement via reference id               bb51120e-dc16-470a-81e6-788b89f82130 dated 2021-11-30 00:00:00</p>
         </div>
         <div class="authorized_box" style="text-align:right;">
            <p><b>For ZOMATO LIMITED (FORMERLY KNOWN AS ZOMATO PRIVATE LIMITED AND ZOMATO MEDIA PRIVATE LIMITED)</b></p>
         ...
         <div class="invoice_address" style="text-align:center;">
            ...
            <p>Please refer to <a href="http://chelab.local.com/">http://chelab.local.com/</a> for current version of full terms & conditions which are incorporated in this invoice by reference. By enrolling in Cheflab's Online Ordering Services, you agree to and intend to be bound by Cheflab's current terms & conditions with respect to online ordering.</p>
         </div>
      </div>
   </body>
</html>