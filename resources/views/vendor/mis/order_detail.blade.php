          ...
          <div class="revenue_box  mb-4">
                <div class="row">
                    ...
                    <div class="col-4">
                      <div class="card">
                        <div class="card-body p-4">
                          <h5 class="mb-3">Additions & Deductions</h5>
                          <h6 class="text-danger">₹{{ $order->additions + $order->deductions }}</h6>
                        </div>
                      </div>
                    </div>
                    <div class="col-4">
                ...
                <div class="table_box">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <td class="border-bottom"><h6>Order ID</h6></td>
                        <td class="border-bottom">{{ $order->order_id }}</td>
                      </tr> 
                      <tr>
                        <td class="border-bottom"><h6>Order Date</h6></td>
                    ...
                    <tbody>
                      <tr>
                        <td class="border-bottom"><h6>Status</h6></td>
                        <td class="border-bottom">{{ $order->order_id }}</td>
                      </tr>                    
                      <tr>
                        <td class="border-bottom"><h6>Payment Method </h6></td>
                    ...
                    <tbody>
                      <tr>
                        <td class="border-bottom"><h6>Payment Status</h6></td>
                        <td class="border-bottom">{{ $order->payment_status }}</td>
                      </tr>                    
                      <tr>
                        <td class="border-bottom"><h6>Unsettled  amount</h6></td>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <table class="table table-borderless">
                          <tbody>
                            <tr>
                              <td class="border-bottom"><h6>Commission</h6></td>
                              <td class="border-bottom">₹{{ $order->admin_amount }}</td>
                            </tr> 
                            <tr>
                              <td class="border-bottom"><h6>Tax On Commission</h6></td>
                        ...
                        <table class="table table-borderless">
                          <tbody>
                            <tr>
                              <td class="border-bottom"><h6>Convenience Fee</h6></td>
                              <td class="border-bottom">₹{{ $order->convenience_amount }}</td>
                            </tr> 
                            <tr>
                              <td class="border-bottom"><h6>TDS amount</h6></td>
                              <td class="border-bottom">₹0</td>
                            </tr>
