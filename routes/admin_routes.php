...
Route::group(['middleware' => ['isAdmin'], 'prefix' => 'admin'], function () {
  ...
  Route::post('deliver_boy/inactive/{id}', [App\Http\Controllers\admin\Deliveryboy::class, 'deliver_boy_inactive'])->name('admin.deliver_boy.inactive');
  Route::post('deliver_boy/active/{id}', [App\Http\Controllers\admin\Deliveryboy::class, 'deliver_boy_active'])->name('admin.deliver_boy.active');
  ...
  Route::get('globle-razorpay-setup', [App\Http\Controllers\admin\GlobleSetting::class, 'razorpay_setup'])->name('admin.globle.setting.razorpay.setup');
  Route::get('globle-cashfree-setup', [App\Http\Controllers\admin\GlobleSetting::class, 'cashfree_setup'])->name('admin.globle.setting.cashfree.setup');
  ...
  // system user start
  Route::get('system-user', [App\Http\Controllers\admin\UserControllers::class, 'create_system_user'])->name('admin.system.user.list');
  Route::get('system-user-emailcheck', [App\Http\Controllers\admin\UserControllers::class, 'checkSystemUserExist'])->name('admin.systemuser.emailcheck');
  Route::post('system-user', [App\Http\Controllers\admin\UserControllers::class, 'post_system_user'])->name('admin.system.user.store');
  //End of syste user
  // Payout setting
  ...
  //
  Route::get('roles', [App\Http\Controllers\admin\RoleController::class, 'index'])->name('admin.role.list');
  Route::post('roles-create', [App\Http\Controllers\admin\RoleController::class, 'create'])->name('admin.role.create');
  Route::get('roles-list', [App\Http\Controllers\admin\RoleController::class, 'get_data_table_of_role'])->name('admin.role.datatable');
  Route::get('roles-assign-permission/{id}', [App\Http\Controllers\admin\RoleController::class, 'assignPermission'])->name('admin.role.assign.permission');
  Route::post('roles-assign-permission/{id}', [App\Http\Controllers\admin\RoleController::class, 'assignPermissionPost'])->name('admin.role.assign.permission.post');
