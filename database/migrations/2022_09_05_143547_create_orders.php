...
class CreateOrders extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->enum('order_status',['pending','preparing','ready_to_dispatch','dispatched','cancelled_by_customer','cancelled_by_vendor','completed','accepted','payment_pending'])->default('pending');
