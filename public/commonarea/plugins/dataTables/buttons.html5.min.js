(function (i) {
  ...
  var z = {
    ...
    H = [
      ...
      { match: /^\-?\$[\d,]+.?\d*$/, style: 57 },
      { match: /^\-?Ã‚Â£[\d,]+.?\d*$/, style: 58 },
      { match: /^\-?Ã¢â€šÂ¬[\d,]+.?\d*$/, style: 59 },
      {
        match: /^\([\d,]+\)$/,
        style: 61,
        fmt: function (a) {
    ...
    action: function (a, c, d, b) {
      ...
      f = i(
        "<span>" +
          c.i18n(
            "buttons.copyKeys",
            "Press <i>ctrl</i> or <i>Ã¢Å’Ëœ</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape."
          ) +
          "</span>"
      ).append(d);
