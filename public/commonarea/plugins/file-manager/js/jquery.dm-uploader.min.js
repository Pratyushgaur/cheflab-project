...
!(function (e) {
  ...
  (a.prototype.upload = function () {
    ...
    if (!t.canUpload())
      return (
        t.widget.queueRunning && t.status !== i && t.widget.processQueue(), !1
      );
    var n = new FormData();
    n.append(t.widget.settings.fieldName, t.data);
    var s = t.widget.settings.extraData;
    return (
      "function" == typeof s && (s = s.call(t.widget.element, t.id)),
        ...
        n.upload &&
          n.upload.addEventListener(
            ...
            function (e) {
              ...
              e.lengthComputable && (n = Math.ceil((i / s) * 100)),
  ...
  (l.prototype.checkSupport = function () {
    ...
    (l.prototype.init = function () {
      ...
      var i = n.element.is("input[type=file]")
        ? n.element
        : n.element.find("input[type=file]");
      return (
        i.length > 0 &&
          (i.prop("multiple", this.settings.multiple),
          i.on("change." + t, function (t) {
            var i = t.target && t.target.files;
            i && i.length && (n.addFiles(i), e(this).val(""));
          })),
        this.settings.dnd && this.initDnD(),
        0 !== i.length || this.settings.dnd
    ...
    (l.prototype.initDnD = function () {
      ...
      n.element.on("drop." + t, function (e) {
        e.preventDefault(),
          n.draggingOver > 0 &&
            ((n.draggingOver = 0), n.settings.onDragLeave.call(n.element));
        var t = e.originalEvent && e.originalEvent.dataTransfer;
        if (t && t.files && t.files.length) {
          var i = [];
          n.settings.multiple ? (i = t.files) : i.push(t.files[0]),
            n.addFiles(i);
        }
      }),
        n.element.on("dragenter." + t, function (e) {
          e.preventDefault(),
            0 === n.draggingOver && n.settings.onDragEnter.call(n.element),
            n.draggingOver++;
        }),
        n.element.on("dragleave." + t, function (e) {
          e.preventDefault(),
            n.draggingOver--,
            0 === n.draggingOver && n.settings.onDragLeave.call(n.element);
        }),
        n.settings.hookDocument &&
          (e(document)
            .off("drop." + t)
            .on("drop." + t, function (e) {
              e.preventDefault(),
                n.draggingOverDoc > 0 &&
                  ((n.draggingOverDoc = 0),
                  n.settings.onDocumentDragLeave.call(n.element));
            }),
          e(document)
            .off("dragenter." + t)
            .on("dragenter." + t, function (e) {
              e.preventDefault(),
                0 === n.draggingOverDoc &&
                  n.settings.onDocumentDragEnter.call(n.element),
                n.draggingOverDoc++;
            }),
          e(document)
            .off("dragleave." + t)
    ...
    (l.prototype.validateFile = function (t) {
      if (this.settings.maxFileSize > 0 && t.size > this.settings.maxFileSize)
        return this.settings.onFileSizeError.call(this.element, t), !1;
      if (
        "*" !== this.settings.allowedTypes &&
        !t.type.match(this.settings.allowedTypes)
      )
        return this.settings.onFileTypeError.call(this.element, t), !1;
      if (null !== this.settings.extFilter) {
        var n = t.name.toLowerCase().split(".").pop();
        if (e.inArray(n, this.settings.extFilter) < 0)
          return this.settings.onFileExtError.call(this.element, t), !1;
      }
      return new a(t, this);
    }),
    (l.prototype.addFiles = function (e) {
      for (var t = 0, n = 0; n < e.length; n++) {
        ...
        if (i) {
          !1 !== this.settings.onNewFile.call(this.element, i.id, i.data) &&
            (this.settings.auto && !this.settings.queue && i.upload(),
            this.queue.push(i),
            t++);
        }
      }
    ...
    (l.prototype.methods = {
      start: function (t) {
        ...
        return void 0 === t || (i = this.findById(t))
          ? i
            ? (i.status === r && (i.status = n), i.upload())
            : (this.startAll(), !0)
    ...
    (e.fn.dmUploader = function (n) {
      ...
      this.each(function () {
        var s = e.data(this, t);
        s instanceof l
          ? "function" == typeof s.methods[n]
            ? s.methods[n].apply(s, Array.prototype.slice.call(i, 1))
            : e.error("Method " + n + " does not exist in jQuery.dmUploader")
