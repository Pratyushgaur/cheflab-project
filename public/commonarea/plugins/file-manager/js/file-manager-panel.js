    ...
    success: function (response) {
      ...
      if (obj.result == 1) {
        document.getElementById(
          "image_file_manager_upload_response"
...
$(document).on(
  "click",
  "#imageFileManagerModal #btn_file_manager_select",
  function () {
    select_image();
  }
);
...
$(document).on(
  "click",
  "#imageFileManagerModal #btn_file_manager_delete",
  function () {
...
$(document).on("click", "#btn_delete_blog_main_image", function () {
  var content =
    '<a class="btn-select-image" data-toggle="modal" data-target="#imageFileManagerModal">' +
