    ...
    */
    ...
    public function restaurantHomePage(Request $request)
    {
        try {
           ...
           return  $vendor_ids = get_active_time_restaurant_ids_near_me($request->lat, $request->lng, $where, false)->toArray(); //not need to pass offset; limit set on products
            ...
            // product details
            $products = topRatedProducts(['product_for' => '3'], request()->user()->id, 'products.product_rating', 'desc', true, false, $vendor_ids, $request->product_offset, $request->product_limit, false, null);
